...
int acolar(t_cola *cola,const t_file *dato);
int desacolar(t_cola *cola,t_file *dato);
void vaciarCola(t_cola *cola);
int colaVacia(const t_cola *cola);
int colaLlena(const t_cola *cola);
int verPrimero(const t_cola *cola, t_file *dato);
void mostrarLaCola(const t_cola *cola);
